<template>
  <div class="h-screen w-screen bg-neutral-950 flex flex-col overflow-hidden">
    ...
    <div class="title-bar flex items-center justify-between bg-neutral-900 border-b border-neutral-800" style="height: 32px; -webkit-app-region: drag; flex-shrink: 0;">
      <div class="flex items-center gap-2.5 pl-3" style="-webkit-app-region: no-drag;">
        <svg viewBox="189.42 64.02 448.8 437.25" class="w-4 h-4 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" style="display: block;">
        ...
        <span class="text-xs font-normal text-neutral-300" style="line-height: 16px; display: block;">Projector</span>
      </div>
    ...
    <div class="flex-1 flex p-4 gap-4 min-h-0 relative">
      ...
      <div class="w-56 bg-neutral-900/50 backdrop-blur rounded-xl border border-neutral-800 p-3 overflow-y-auto flex flex-col">
        ...
        <div class="space-y-1 flex-1">
          ...
          >
            <!-- Stack Header -->
            <div class="px-2 py-1.5 hover:bg-neutral-700/50 transition-all" :class="stackIndex === stagedStackIndex ? 'bg-gold-500/10' : ''">
              <!-- Stack Title Row -->
    ...
    <div class="bg-neutral-900/50 backdrop-blur border-t border-neutral-800 px-4 py-2" style="flex-shrink: 0;">
      <div class="flex items-center gap-2">
        <button
          @click="prevSlide"
          :disabled="!canGoPrevSlide"
